 ...
 */
final class Version20220409164524 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mois ADD actual DOUBLE PRECISION NOT NULL, ADD budget DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mois DROP actual, DROP budget');
