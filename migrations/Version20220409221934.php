 ...
 */
final class Version20220409221934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait DROP date3, DROP actual3, DROP budget3');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait ADD date3 DATE DEFAULT NULL, ADD actual3 DOUBLE PRECISION DEFAULT NULL, ADD budget3 DOUBLE PRECISION DEFAULT NULL');
