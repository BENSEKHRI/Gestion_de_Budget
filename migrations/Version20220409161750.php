 ...
 */
final class Version20220409161750 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait ADD CONSTRAINT FK_954BB31FEEB99D97 FOREIGN KEY (produit2_id) REFERENCES produit (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
