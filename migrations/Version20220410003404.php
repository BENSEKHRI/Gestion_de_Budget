 ...
 */
final class Version20220410003404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait DROP INDEX IDX_954BB31FF347EFB, ADD UNIQUE INDEX UNIQ_954BB31FF347EFB (produit_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait DROP INDEX UNIQ_954BB31FF347EFB, ADD INDEX IDX_954BB31FF347EFB (produit_id)');
