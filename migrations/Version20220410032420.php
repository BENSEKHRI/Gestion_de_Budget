 ...
 */
final class Version20220410032420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait CHANGE actualvol1 actual_vol1 INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait CHANGE actual_vol1 actualvol1 INT DEFAULT NULL');
