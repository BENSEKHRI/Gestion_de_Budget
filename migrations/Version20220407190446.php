 ...
 */
final class Version20220407190446 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait ADD CONSTRAINT FK_954BB31F68DB5B2E FOREIGN KEY (canal_id) REFERENCES canal (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE fait ADD CONSTRAINT FK_954BB31FF347EFB FOREIGN KEY (produit_id) REFERENCES produit (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE fait ADD CONSTRAINT FK_954BB31FF713E42E FOREIGN KEY (geographie_id) REFERENCES geographie (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
