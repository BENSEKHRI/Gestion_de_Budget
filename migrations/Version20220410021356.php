 ...
 */
final class Version20220410021356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait DROP date, DROP date1, DROP date2');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait ADD date DATE NOT NULL, ADD date1 DATE DEFAULT NULL, ADD date2 DATE DEFAULT NULL');
