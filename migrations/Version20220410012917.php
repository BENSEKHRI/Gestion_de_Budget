 ...
 */
final class Version20220410012917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mois (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, date1 DATE DEFAULT NULL, date2 DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
