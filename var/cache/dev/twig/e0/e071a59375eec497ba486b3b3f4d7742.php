...
class __TwigTemplate_b273dfa74cd928849d93e9d9b38b3946 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container-fluid\">
            ...
            <div class=\"col-md-6 text-center p-4\">
                ...
                <h1 class=\"mb-4\">Accès interdit</h1>
                <p class=\"mb-4\">Nous sommes désolés, vous n'avais pas la permissionn d'accèder à la page que vous avez recherchée sur notre site !</p>
                <a href=\"";
        // line 13
...
{% block body %}
    ...
    <div class=\"container-fluid\">
            ...
            <div class=\"col-md-6 text-center p-4\">
                ...
                <h1 class=\"mb-4\">Accès interdit</h1>
                <p class=\"mb-4\">Nous sommes désolés, vous n'avais pas la permissionn d'accèder à la page que vous avez recherchée sur notre site !</p>
                <a href=\"{{ path('app_home') }}\" class=\"btn btn-primary rounded-pill py-3 px-5\" href=\"\">Retourner à l'accueil</a>
            </div>
        </div>
    </div>
    <!-- 404 End -->
...
{% endblock %}
", "@Twig/Exception/error403.html.twig", "/home/lounis/GP/Gestion_de_budget/templates/bundles/TwigBundle/Exception/error403.html.twig");
    }
}
