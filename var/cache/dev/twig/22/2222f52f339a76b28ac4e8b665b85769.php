...
class __TwigTemplate_412a57e676850ddda620118b57daaa8f extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container-fluid pt-4 px-4\">
        <div class=\"row vh-100 bg-light rounded align-items-center justify-content-center mx-0\">
            <div class=\"col-md-6 text-center p-4\">
                ...
                <p class=\"mb-4\">Nous sommes désolés, Vous devez vous connecter pour accéder à cette page !  Vous pouvez peut-être aller sur notre page de connexion ?</p>
                <a href=\"";
        // line 13
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_login");
        echo "\" class=\"btn btn-primary rounded-pill py-3 px-5\" href=\"\">Retourner à la page de connexion</a>
            </div>
        </div>
    </div>
    <!-- 404 End -->
...
{% block title %}Utilisateur non authentifié{% endblock %}
    ...
    <div class=\"container-fluid pt-4 px-4\">
        <div class=\"row vh-100 bg-light rounded align-items-center justify-content-center mx-0\">
            <div class=\"col-md-6 text-center p-4\">
                ...
                <h1 class=\"mb-4\">Utilisateur non authentifié</h1>
                <p class=\"mb-4\">Nous sommes désolés, Vous devez vous connecter pour accéder à cette page !  Vous pouvez peut-être aller sur notre page de connexion ?</p>
                <a href=\"{{ path('app_login') }}\" class=\"btn btn-primary rounded-pill py-3 px-5\" href=\"\">Retourner à la page de connexion</a>
            </div>
        </div>
    </div>
    <!-- 404 End -->
...
{% endblock %}
", "@Twig/Exception/error401.html.twig", "/home/lounis/GP/Gestion_de_budget/templates/bundles/TwigBundle/Exception/error401.html.twig");
    }
}
