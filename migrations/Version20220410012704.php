 ...
 */
final class Version20220410012704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait CHANGE actual actual DOUBLE PRECISION NOT NULL, CHANGE budget budget DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fait CHANGE actual actual DOUBLE PRECISION DEFAULT NULL, CHANGE budget budget DOUBLE PRECISION DEFAULT NULL');
