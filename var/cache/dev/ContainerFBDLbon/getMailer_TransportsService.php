...
class getMailer_TransportsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['mailer.transports'] = ($container->privates['mailer.transport_factory'] ?? $container->load('getMailer_TransportFactoryService'))->fromStrings(['main' => $container->getEnv('MAILER_URL')]);
    }
}
